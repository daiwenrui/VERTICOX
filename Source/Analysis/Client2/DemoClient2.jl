...
USER=Dict{Any,Any}("username"=>"UCSD002",
                   ...
                   "taskID"=>"t001");
# get local data
X = readcsv("C:/VERTICOX/Source/Analysis/Client2/uaru2.txt");
Xnew =readcsv("C:/VERTICOX/Source/Analysis/Client2/uaru2_test.txt");
beta1b = readcsv("C:/VERTICOX/Source/Analysis/Client2/para2.txt");
